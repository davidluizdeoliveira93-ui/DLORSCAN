...
<head>
    ...
    <meta name="description" content="DLORSCAN - Jogos únicos em códigos de barras criados por DLOR">
    <meta name="author" content="DLOR">
    <title>⚡ DLORSCAN • Jogos em Códigos de Barras</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        /* Linha decorativa de scan no topo */
        .scanline {
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
            height: 2px;
            background: linear-gradient(90deg, transparent, #5f7eff, #c084fc, transparent);
            box-shadow: 0 0 20px #5f7eff, 0 0 40px #c084fc;
        ...
        @keyframes pulse {
            0%, 100% { box-shadow: 0 0 20px #5f7eff55, inset 0 0 10px #00000066; }
            50% { box-shadow: 0 0 35px #5f7eff99, inset 0 0 15px #00000088; }
        }
        ...
        h1 {
            ...
            background-clip: text;
            color: transparent;
            text-shadow: 0 0 30px rgba(107, 140, 255, 0.6);
...
<body>
    ...
    <h1>DLORSCAN</h1>
    <div class="tagline">barcode games • tech arcade</div>
    ...
    <div class="footer">
        ...
        <span class="brand">DLORSCAN</span>
        <span class="signature">criado por <strong>DLOR</strong> © 2026</span>
    </div>
